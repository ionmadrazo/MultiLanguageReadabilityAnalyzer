...
In this paper we present our ongoing efforts on the development of YouUndestood.me (YUM), an enhanced web search environment tailored to children ages 6 to 15. YUM, which is based on a popular search engine, aims to foster learning though the retrieval of materials that not only satisfy the information needs of its users but also match their reading abilities. 
YUM facilitates information discovery for both teachers and students by (i) recognizing users' search intent, (ii) providing query suggestions, (iii) retrieving suitable resources, in terms of text complexity, and (iv) tracking students' feedback on the complexity of the resources. In order to showcase the need for this type of environment, we present an initial assessment conducted on YUM and well-known (children-oriented) search engines using queries generated by K-9 students.
\looseness=-1

%YouUnderstood.me is an enhanced web environment  specifically designed to help students deal with search for learning tasks and allow teachers to track their students' progress.




%We present our ongoing efforts on the development of a search environment tailored to 6-15 year-olds that can foster learning though the retrieval of materials that not only satisfy the information needs of users but also match their reading abilities.
%YouUnderstood.me is an enhanced environment based on a popular search engine specifically designed to help students deal with search for learning tasks and allow teachers to track their students' progress. An initial assessment conducted on YouUnderstood.me and well-known (children-oriented) search engines using queries generated by K-9 students, showcases the need for this type of environment.
\looseness=-1
\end{abstract}
...
considers $w_{c_i}$ which is a weight that captures the recentness on $c_i$, ranging from 9 to 1, depending on the number of months that have passed since $c_i$ was created.
 % In case of multiple maximum values, the one that has the biggest distance to its two (lower and upper) closest constraints is selected 
...
\multicolumn{1}{|l|}{\textbf{Average readability (Flesch)}}                                  & \begin{tabular}[c]{@{}l@{}}Chosen\\ by the user\end{tabular} & 12.4                                                                    & 12.8                                                                     & 10.6            & 15.6                                                        & 11.6                                                                     \\ \hline
...
\caption{Comparison of search environments using 300 queries written by K-9 children}
\label{table:aspects}
\vspace{-0.5cm}
\end{table*}
